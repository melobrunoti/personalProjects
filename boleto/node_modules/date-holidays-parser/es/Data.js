...
var Data = /*#__PURE__*/function () {
  ...
  _proto.getCountries = function getCountries(lang) {
    var _this = this;
  ...
  _proto.getStates = function getStates(country, lang) {
    var _this2 = this;
  ...
  _proto.getRegions = function getRegions(country, state, lang) {
    var _this3 = this;
  ...
  _proto._name = function _name(obj, key, lang, opts) {
  ...
  _proto.getLanguages = function getLanguages(opts) {
  ...
  _proto.getDayOff = function getDayOff() {
  ...
  _proto.getTimezones = function getTimezones() {
  ...
  _proto.getRules = function getRules(country, state, region) {
    var _this4 = this;
  ...
  _proto.getSubstitueNames = function getSubstitueNames() {
  ...
  _proto._assign = function _assign(out, obj) {
    var days = {};
  ...
  _proto._getValue = function _getValue(key, opts) {
    if (opts === void 0) {
      opts = this.opts;
    }
